...
export const ShiftReceiptPrintView: React.FC<ShiftReceiptPrintViewProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-70 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs overflow-y-auto no-print:flex print:block print:p-0 print:bg-white print:static">
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden flex flex-col max-h-[95vh] print:max-w-full print:border-none print:shadow-none print:rounded-none">
        ...
        <div className="bg-slate-900 text-white px-5 py-3.5 flex items-center justify-between no-print shrink-0">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h4 className="text-sm font-bold">Απόδειξη Κλεισίματος Βάρδιας</h4>
              <p className="text-[10px] text-slate-300">Format για εκτυπωτές αποδείξεων (Thermal 80mm / A4)</p>
            </div>
          </div>
          <button
            onClick={onClose}
